...
Else
    ...
    RSave.Edit
        ...
        RSave("Alamat") = Format(Trim(Text3), ">")
        RSave("Telepon") = Trim(Text4)
        RSave("Rekening") = Trim(Text5)
    RSave.Update
    RSave.Close5
    Set RSave = Nothing
    Call IsiGrid
...
Else
    ...
    RSave2.AddNew
        ...
        RSave2("Alamat") = Format(Text3, ">")
        RSave2("Telepon") = Format(Text4, ">")
        RSave2("Rekening") = Format(Text5, ">")
    RSave2.Update
    RSave2.Close
    Set RSave2 = Nothing
    Call IsiGrid
...
If Text1 = "" Or Text2 = "" Or Text3 = "" Or Text4 = "" Or Text5 = "" Then
    ...
    Text1.SetFocus
Else
    SDel = "Delete From P001 where Kode = '" + Trim(KB) + "'"
...
With grid
    ...
    .Col = 2: .ColWidth(2) = 2500: .Text = "ALAMAT": .CellAlignment = 4
    .Col = 3: .ColWidth(3) = 1000: .Text = "TELEPON": .CellAlignment = 4
    .Col = 4: .ColWidth(4) = 1000: .Text = "REKENING": .CellAlignment = 4
End With
End Sub
...
Private Sub CekData()
SCari = "Select * From P001 where Kode = '" + Trim(Text1) + "'"
Set RCari = RDCO.OpenResultset(SCari, rdOpenDynamic, rdConcurRowVer)
If RCari.RowCount <> 0 Then
    MsgBox "KODE PELANGGAN SUDAH ADA", vbCritical, "KONFIRMASI"
    Text1 = ""
    Text1.SetFocus
End If
RCari.Close
