...
crpt.ReportFileName = App.Path & "\ReportTOKO\MutasiHutang.rpt"
crpt.SelectionFormula = "{H001.NO_HUTANG} = '" + Trim(Text5) + "'"
...
SSave = "Select * From H001 where No_Hutang = '" + Trim(Text5) + "'"
...
With grid
    ...
    .Col = 3: .ColWidth(3) = 2500: .Text = "NAMA SUPPLIER": .CellAlignment = 4: .CellFontBold = True
...
Private Sub IsiGrid()
SCari = "Select * From H001 where Status_Bayar = '0' order by No_Hutang Asc"
