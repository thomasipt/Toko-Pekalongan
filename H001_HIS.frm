...
Begin VB.Form H001_HIS 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   240
         Left            =   180
         OleObjectBlob   =   "H001_HIS.frx":0000
         TabIndex        =   20
         Top             =   495
         Width           =   1365
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   240
         Left            =   180
         OleObjectBlob   =   "H001_HIS.frx":0066
         TabIndex        =   21
         Top             =   855
         Width           =   1365
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   240
         Left            =   180
         OleObjectBlob   =   "H001_HIS.frx":00DE
         TabIndex        =   22
         Top             =   1215
         Width           =   1365
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   240
         Left            =   180
         OleObjectBlob   =   "H001_HIS.frx":0148
         TabIndex        =   23
         Top             =   1575
         Width           =   1365
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   240
         Left            =   3330
         OleObjectBlob   =   "H001_HIS.frx":01BA
         TabIndex        =   24
         Top             =   360
         Width           =   1590
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   240
         Left            =   3330
         OleObjectBlob   =   "H001_HIS.frx":022A
         TabIndex        =   25
         Top             =   720
         Width           =   1590
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   240
         Left            =   3330
         OleObjectBlob   =   "H001_HIS.frx":02A4
         TabIndex        =   26
         Top             =   1080
         Width           =   1590
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   240
         Left            =   3330
         OleObjectBlob   =   "H001_HIS.frx":0318
         TabIndex        =   27
         Top             =   1440
         Width           =   1590
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   6210
      OleObjectBlob   =   "H001_HIS.frx":038C
      Top             =   2655
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel15 
      Height          =   195
      Left            =   180
      OleObjectBlob   =   "H001_HIS.frx":05C0
      TabIndex        =   14
      Top             =   2767
      Width           =   1410
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   195
      Left            =   15
      OleObjectBlob   =   "H001_HIS.frx":0632
      TabIndex        =   16
      Top             =   5782
      Width           =   2805
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   195
      Left            =   10020
      OleObjectBlob   =   "H001_HIS.frx":06C8
      TabIndex        =   18
      Top             =   5782
      Width           =   2805
   End
End
Attribute VB_Name = "H001_HIS"
...
If Text1 = "" Then
    MsgBox "PILIH NO. HUTANG", vbCritical, "KONFIRMASI"
Else
    Frame1.Visible = True
...
Else
    crpt.ReportFileName = App.Path & "\ReportTOKO\MutasiHUTANG2.rpt"
    crpt.SelectionFormula = "{H001.NO_HUTANG} = '" + Trim(Text1) + "'"
...
With grid
    ...
    .Row = 0
    .RowHeight(0) = 500
    .Col = 0: .ColWidth(0) = 1500: .Text = "NO HUTANG": .CellAlignment = 4: .CellFontBold = True
...
Private Sub IsiGrid()
SCari = "Select * From H001 where Status_Bayar = '0' order by Tgl_Mulai Asc"
...
SCari2 = "Select * From H001_HIS where NO_HUTANG = '" + Trim(Text1) + "'"
...
If KB = "" Then Exit Sub
    ...
    SSave = "Select * From H001_HIS where NO_GIRO='" + Trim(KB) + "'"
    Set RSave = RDCO.OpenResultset(SSave, rdOpenDynamic, rdConcurRowVer)
...
If KB = "" Then Exit Sub
    ...
    SCari = "Select * From H001_HIS where NO_GIRO='" + Trim(KB) + "'"
